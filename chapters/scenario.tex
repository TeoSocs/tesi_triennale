...
\section{Sfide e ambiti di ricerca}
    \subsection{Efficienza e scalabilità}
        ...
        \end{itemize}
        Il problema della scalabilità dei sistemi blockchain è molto dipendente dall'algoritmo di consenso implementato.
        ...
        PoW bello ma costoso in termini di risorse
