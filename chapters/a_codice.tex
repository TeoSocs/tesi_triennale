...
\end{lstlisting}
	...
	\subsection{Definire le caratteristiche della rete}
		...
		\lstinputlisting[language=JavaScript]{chapters/code/voting-network/models/eurasia.voting.cto}
	...
	\subsection{Scrivere la logica delle transazioni in JavaScript}
		...
		\lstinputlisting[language=JavaScript]{chapters/code/voting-network/lib/logic.js}
	...
	\subsection{Aggiungere il controllo agli accessi}
		...
		\lstinputlisting[language=JavaScript]{chapters/code/voting-network/permissions.acl}
